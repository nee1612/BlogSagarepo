    ...
    <div className="">
      <div class="top-0 z-40  w-full border-b shadow-md border-gray-300 bg-white  fixed py-1 ">
        <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
          ...
          <div class="hidden space-x-2 md:block">
            {refToken ? (
              ...
              >
                <button
                  onClick={logOut}
                  className=" tap-transparent inline-flex w-full items-center justify-center rounded-sm bg-slate-800  px-3.5 py-1 font-medium leading-6 text-white hover:bg-black/80"
                >
                  Logout
                </button>
              </motion.div>
          ...
          <div
            onClick={click}
            class=" tap-transparent md:hidden absolute top-7 right-4 z-40"
          >
            <FaBars size={22} />
          </div>
          {/* <TTR/> */}
